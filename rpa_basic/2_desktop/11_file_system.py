...
# os.chdir("rpa_basic") # rpa_basic 으로 작업 공간이동
# print(os.getcwd())
# os.chdir("..") # 부모 폴더로 이동
# print(os.getcwd())
# os.chdir("../..") # 조부모 폴더로 이동
...
# 파일 경로에서 폴더 정보 가져오기
# print(os.path.dirname(r"C:\Users\이승미\OneDrive\바탕 화면\Pythonworkspace\my_file.txt"))
...
# 주어진 경로가 파일인지? 폴더인지?
# print(os.path.isdir("rpa_basic")) # rpa_basic 은 폴더인가? T
# print(os.path.isfile("rpa_basic")) # rpa_basic 은 파일인가? F
...
# os.mkdir("c/users/") # 절대경로 기준으로 폴더 생성
...
# shutil.copy("run_btn.png", "test_folder/copied_run_btn.png") # 원본 경로, 대상경로 (변경된 파일명까지)
# shutil.copyfile("run_btn.png", "test_folder/copied_run_btn_2.png") # 원본 파일 경로, 대상 파일 경로

# shutil.copy("run_btn.png","test_folder/copy.png") # 원본 파일 경로, 대상 폴더(파일) 경로
...
# 폴더 이동
# shutil.move("test_folder","test_folder2") folder를 folder2 밑으로 이동 
# shutil.move("test_folder","test_folder2") # 폴더 명 변경되는 효과
